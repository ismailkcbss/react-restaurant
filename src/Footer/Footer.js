        ...
        <div className="FooterDiv">
            ...
            <div className="SocialMedia">
                <div>
                    ...
                    <a target="_blank" href="https://www.linkedin.com/"><LinkedInIcon className='icon' style={{ color: "#045079" }} /></a>
                    ...
                    <a target="_blank" href="https://z-p15.www.instagram.com/accounts/login/?next=/ali_0rg/followers/&source=followed_by_list&hl=tr"><InstagramIcon className='icon' style={{ color: "#ff4e9b" }} /></a>
                </div>
            </div>
